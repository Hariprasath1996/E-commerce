...
<NavLink to="/Shop" type="button" className="  bg-gradient-to-r from-sky-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 ...  rounded-medium p-3 rounded-lg text-white text-xl font-bold relative bottom-16 left-[18rem]  ">
SHOP NOW</NavLink>
</div>
<div>
