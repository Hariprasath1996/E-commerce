...
const ProductCard = ({name,price,image})=>{
    return (
        ...
        //         hover:scale-105 gap-4 shadow-lg rounded-lg overflow-hidden justify-evenly    ">
            ...
            <Button   className="hover:cursor-pointer hover:translate-y-1 p-2 bg-white text-black rounded-md font-bold border-4 border-yellow-400/100 ... mb-3" buttonType="inverted">Add To Cart</Button>
        </main>
    )
}
export {ProductCard} ;